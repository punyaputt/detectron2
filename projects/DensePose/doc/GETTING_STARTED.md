...
2. Run the [Apply Net](TOOL_APPLY_NET.md) tool to visualize the results or save to the disk. For example, to use contour visualization for DensePose, one can run:
```bash
